...
Add-HostsEntry "cm.xmdemo1.local"
Add-HostsEntry "id.xmdemo1.local"
Add-HostsEntry "www.xmdemo1.local"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.xmdemo1.local"
    
    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.xmdemo1.local"
    ...
    Set-EnvFileVariable "JSS_DEPLOYMENT_SECRET" -Value (Get-SitecoreRandomString 32 -DisallowSpecial -EnforceComplexity)
